...
4. Target migration waves: `docs/specs/target-architecture-and-migration.md`
5. Fast context anchor: `docs/specs/baseline-snapshot.md`
6. Wave 4 closure checkpoint: `docs/project-monitoring/waves/wave-4-closure-checkpoint.md`
7. Wave 5 closure checkpoint: `docs/project-monitoring/waves/wave-5-closure-checkpoint.md`
8. PoC parity baseline: `docs/specs/poc-parity-baseline.md`
...
7. Operator UI uses React (React 18 + React Router + Vite).
