...
6. Operator UI stack is React (React 18 + React Router + Vite).
...
13. V1 must preserve at least PoC-level functional parity (see `docs/specs/poc-parity-baseline.md`).
...
- Migration execution uses the wave model in `docs/specs/target-architecture-and-migration.md`.
...
- Evidence: `docs/project-monitoring/waves/wave-4-closure-checkpoint.md` and `docs/project-monitoring/waves/wave-5-closure-checkpoint.md`.
- Status source of truth: `docs/specs/target-architecture-and-migration.md` Wave Status Matrix.
