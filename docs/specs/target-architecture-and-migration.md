...
1. Detailed V1 specification: `docs/specs/v1-system-specification.md`
2. BDD use-case suite: `docs/bdd/README.md`
3. Multi-repo setup and governance: `docs/specs/multi-repo-operating-model.md`
4. Fast context anchor: `docs/specs/baseline-snapshot.md`
5. Wave 4 closure evidence: `docs/project-monitoring/waves/wave-4-closure-checkpoint.md`
6. Wave 5 closure evidence: `docs/project-monitoring/waves/wave-5-closure-checkpoint.md`
7. Forward alignment guardrails: `docs/project-monitoring/waves/wave-forward-alignment-audit.md`
8. Container image/tag governance: `docs/specs/container-image-tagging-policy.md`
9. Wave 7 kickoff checkpoint: `docs/project-monitoring/waves/wave-7-kickoff-checkpoint.md`
10. Wave 7 execution backlog: `docs/project-monitoring/waves/wave-7-execution-backlog.md`
11. Wave 7 Schneider BACnet contract freeze: `docs/project-monitoring/waves/wave-7-schneider-bacnet-contract.md`
12. Wave 7 Tandem Connect planning packet: `docs/project-monitoring/waves/wave-7-tandem-connect-planning.md`
13. Wave 7 Siemens Building X planning packet: `docs/project-monitoring/waves/wave-7-siemens-buildingx-planning.md`
14. Wave 7 scale-hardening baseline: `docs/project-monitoring/waves/wave-7-scale-hardening-baseline.md`
15. Wave 7 closure sign-off: `docs/project-monitoring/waves/wave-7-closure-signoff.md`
16. Wave 8 kickoff checkpoint: `docs/project-monitoring/waves/wave-8-kickoff-checkpoint.md`
17. Wave 8 execution backlog: `docs/project-monitoring/waves/wave-8-execution-backlog.md`
18. Wave 8 closure sign-off: `docs/project-monitoring/waves/wave-8-closure-signoff.md`
19. Wave 1 restart kickoff checkpoint: `docs/project-monitoring/waves/wave-1-kickoff-checkpoint.md`
20. Wave 1 execution backlog: `docs/project-monitoring/waves/wave-1-execution-backlog.md`
21. Wave 1 security baseline traceability: `docs/project-monitoring/waves/wave-1-security-baseline-traceability.md`
22. Wave 1 closure sign-off: `docs/project-monitoring/waves/wave-1-closure-signoff.md`
23. Post-wave roadmap backlog: `docs/specs/post-wave-roadmap-backlog.md`
24. PoC parity baseline: `docs/specs/poc-parity-baseline.md`
25. PostgreSQL ownership and operations contract: `docs/specs/postgresql-ownership-and-operations.md`
...
3. Stack choices are fixed: Python services, `paho-mqtt`, React (React 18 + React Router + Vite) operator UI, Camunda with TypeScript integration layer, Keycloak IAM, Grafana OSS.
...
9. For one-building Schneider integration, two architecture hypotheses are valid: (A) EBO as unified command center, or (B) AS-P as edge automation boundary and operational owner of subsystems under platform-governed command intent.
10. For one-building Siemens integration, two architecture hypotheses are valid: (A) Desigo CC as unified command/supervision center, or (B) PXC controllers as local operational owners of subsystems under platform-governed command intent, with unified cross-domain supervision provided by Desigo CC (or validated equivalent) when required.
11. PostgreSQL ownership is foundation-managed: one shared cluster, one service DB per service, least-privilege service roles, and managed persistent volume durability.
12. Backup/restore operational ownership for shared PostgreSQL belongs to `platform-foundation`; service teams provide application-level restore-validation evidence.
...
- Shared PostgreSQL lifecycle, service DB/role provisioning, and backup/restore operations.
...
| 1 | Foundation And Security Baseline | completed | Closed on 2026-03-18 with Keycloak baseline, Vault runtime baseline, tenant-isolation evidence, observability baseline, and closure sign-off recorded (see docs/project-monitoring/waves/wave-1-closure-signoff.md). |
...
| 4 | Command And Safety Plane | completed | Frozen on 2026-03-13; see docs/project-monitoring/waves/wave-4-closure-checkpoint.md. |
| 5 | Automation And Operator UI Decoupling | completed | Closed on 2026-03-17 for workflow+UI+auth+e2e slice; see docs/project-monitoring/waves/wave-5-closure-checkpoint.md. |
| 6 | Node-RED Retirement And Hardening | completed | Closed on 2026-03-18; see docs/project-monitoring/waves/wave-6-closure-signoff.md. |
| 7 | Partner Integration Rollout (Post-V1) | completed | Closed and approved on 2026-03-18; see docs/project-monitoring/waves/wave-7-closure-signoff.md. |
| 8 | Production Hardening And Org Migration | completed | Closed on 2026-03-18; hardened image pipeline baseline, namespace normalization (`ghcr.io/olivierlegendre`), and `v0.2.0` pullability/readiness evidence are recorded (see docs/project-monitoring/waves/wave-8-closure-signoff.md). |
...
- Frozen checkpoint: `docs/project-monitoring/waves/wave-4-closure-checkpoint.md`.
...
4. Execution backlog tracked in `docs/project-monitoring/waves/wave-6-execution-backlog.md`.
