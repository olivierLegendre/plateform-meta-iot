...
- Updated:
  ...
  - `docs/project-monitoring/services/platform-foundation/nodered/README.md`
  - `docs/project-monitoring/waves/wave-6-kickoff-checkpoint.md`
...
1. Added formal image/tag policy for temporary org namespace `olivierlegendre` in `docs/specs/container-image-tagging-policy.md`.
...
- owner sign-off and final confirmation that published artifacts are available in target runtime credentials (tracked in `docs/project-monitoring/waves/wave-6-closure-signoff.md`).
