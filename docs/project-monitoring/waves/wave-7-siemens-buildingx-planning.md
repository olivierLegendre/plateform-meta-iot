...
1. `docs/project-monitoring/waves/wave-7-execution-backlog.md` (`W7-08`)
2. `docs/project-monitoring/waves/wave-7-kickoff-checkpoint.md`
3. `docs/project-monitoring/waves/wave-7-schneider-bacnet-contract.md` (reference baseline pattern)
