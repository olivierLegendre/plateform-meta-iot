...
1. `docs/project-monitoring/waves/wave-7-kickoff-checkpoint.md`
2. `docs/project-monitoring/waves/wave-7-execution-backlog.md` (`W7-01`)
3. `docs/specs/target-architecture-and-migration.md` (Wave 7 status/plan)
