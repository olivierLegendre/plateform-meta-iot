...
- Artifact: `docs/project-monitoring/waves/wave-7-kickoff-checkpoint.md`

2. Wave 7 execution backlog reflects W7 evidence trail and completion path.
- Artifact: `docs/project-monitoring/waves/wave-7-execution-backlog.md`

3. Schneider contract freeze and boundary definition exists.
- Artifact: `docs/project-monitoring/waves/wave-7-schneider-bacnet-contract.md`

4. Tandem Connect and Siemens Building X planning packets exist with acceptance criteria.
- Artifacts:
  - `docs/project-monitoring/waves/wave-7-tandem-connect-planning.md`
  - `docs/project-monitoring/waves/wave-7-siemens-buildingx-planning.md`

5. Scale-hardening baseline packet exists with load/observability/integration evidence.
- Artifact: `docs/project-monitoring/waves/wave-7-scale-hardening-baseline.md`
