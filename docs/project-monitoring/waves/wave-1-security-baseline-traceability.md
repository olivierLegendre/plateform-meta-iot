...
| `target-architecture-and-migration.md` Wave 1 Acceptance #3 | Isolation tests prove cross-organization read/write denial | `plateform-meta-iot/docs/project-monitoring/waves/wave-1-tenant-isolation-report.json` | `cd /home/olivier/work/iot_services/plateform-meta-iot && ./scripts/run_wave1_tenant_isolation_checks.sh` | PASS |
...
| `v1-system-specification.md` §5.3 | Hard data isolation at organization boundary | `plateform-meta-iot/docs/project-monitoring/waves/wave-1-tenant-isolation-report.json` | Same as tenant-isolation command above | PASS |
...
2. `plateform-meta-iot/docs/project-monitoring/waves/wave-1-tenant-isolation-report.json`
...
2. Closure sign-off is recorded in `docs/project-monitoring/waves/wave-1-closure-signoff.md`.
